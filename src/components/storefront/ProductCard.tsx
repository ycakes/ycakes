...
export function ProductCard({ cake, priority }: { cake: Cake; priority?: boolean }) {
  ...
  return (
    <Link
      href={`/cakes/${cake.id}`}
      className="group flex w-[340px] shrink-0 snap-start flex-col items-start rounded-3xl bg-bg-surface px-3 pb-4 pt-3 drop-shadow-[0px_1px_1.5px_rgba(43,30,25,0.08)] transition-shadow hover:drop-shadow-[0px_4px_10px_rgba(43,30,25,0.14)]"
    >
