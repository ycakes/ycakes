  ...
  return (
    <main className="flex flex-col bg-bg-page">
      ...
      <div className="flex flex-col gap-6 px-6 py-8 md:px-[100px]">
        ...
        <h1 className="font-heading text-3xl font-extrabold text-text-primary md:text-[40px]">
          {t("title")}
        </h1>
        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
            ...
            <div className="flex w-full flex-col gap-4 rounded-3xl bg-bg-surface p-4 shadow-sm lg:sticky lg:top-6 lg:max-w-[400px]">
